    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 text-center">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {/* Free plan */}
          <div className="rounded-2xl border border-orange-500/40 bg-slate-900/80 p-8 text-left">
            ...
            <p className="mt-2 text-sm text-slate-400">Full access to the entire deflection desk.</p>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-8 text-left">
            ...
            <ul className="mt-6 space-y-2 text-sm text-slate-400">
              <li className="flex items-start gap-2"><span className="mt-0.5 text-slate-500">&#10003;</span> Everything in Free</li>
              <li className="flex items-start gap-2"><span className="mt-0.5 text-slate-500">&#10003;</span> Priority support</li>
              <li className="flex items-start gap-2"><span className="mt-0.5 text-slate-500">&#10003;</span> Higher feed volume ceilings</li>
            </ul>
            <button
              disabled
              className="mt-8 w-full cursor-not-allowed rounded-lg border border-slate-700 py-3 font-semibold text-slate-400"
            >
              {stripeEnabled === null
