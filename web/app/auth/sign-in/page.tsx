    ...
    <main className="flex min-h-screen items-center justify-center bg-neutral-950 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-neutral-100">Sign in to your desk</h1>
          <p className="mt-1 text-sm text-neutral-400">Triage pre-dispute alerts before they become chargebacks.</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-neutral-800 bg-neutral-900 p-8">
          ...
          <div>
            ...
            <input name="password" type="password" required className="w-full rounded-lg border border-neutral-700 bg-neutral-800 px-4 py-3 text-white focus:border-orange-500 focus:outline-none" />
          </div>
