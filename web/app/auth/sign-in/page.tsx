    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-slate-100">Sign in to your desk</h1>
          <p className="mt-1 text-sm text-slate-400">Triage pre-dispute alerts before they become chargebacks.</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-slate-800 bg-slate-900 p-8">
          ...
          <div>
            ...
            <input name="password" type="password" required className="w-full rounded-lg border border-slate-700 bg-slate-800 px-4 py-3 text-white focus:border-orange-500 focus:outline-none" />
          </div>
